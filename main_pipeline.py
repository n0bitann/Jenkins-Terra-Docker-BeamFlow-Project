...
pipeline_args = [
    ...
    '--region=asia-southeast1-a',  # Adjust as per your GCP region
    '--staging_location=gs://tan_workshop2/temp/staging/',  # Change to your bucket path
    '--temp_location=gs://tan_workshop2/temp',  # Change to your bucket path
    '--streaming',
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/labdap/topics/tan-transactions"  # Change to your PubSub topic
 )
